...
public class BinaryNode {
    ...
    public Integer getMaxFamilyValue() {
        return maxFamilyValue;
    }

    public void setMaxFamilyValue(Integer maxFamilyValue) {
        this.maxFamilyValue = maxFamilyValue;
    }

    private Integer maxFamilyValue=null;
